...
ls /dev | grep sd > stotage_devs.txt
echoDetected "Storage devices:" stotage_devs.txt 

ls /dev | grep ttyUSB > tty_devs.txt
...
do
    ...
    echoDiff stotage_devs.txt sd
    echoDiff tty_devs.txt ttyUSB
